...
val INEQSYM: (CMSemantic.ineqsym) *  'a * 'a -> (svalue,'a) token
val EQSYM: (CMSemantic.eqsym) *  'a * 'a -> (svalue,'a) token
val MULSYM: (CMSemantic.mulsym) *  'a * 'a -> (svalue,'a) token
val ADDSYM: (CMSemantic.addsym) *  'a * 'a -> (svalue,'a) token
